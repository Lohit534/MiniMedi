      ...
      <div className="max-w-md w-full space-y-6 relative z-10">
        ...
        <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-gray-100 dark:border-slate-800 rounded-3xl p-6 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5)]">
          ...
          <form className="space-y-4" onSubmit={handleLogin}>
              ...
              <div>
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none z-20">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4.5 w-4.5 text-gray-400 group-focus-within:text-black dark:group-focus-within:text-white transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex items-center justify-between px-1">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2 block text-[11px] text-gray-500 dark:text-gray-500 font-bold cursor-pointer uppercase tracking-tight">
                  Remember
                </label>
              </div>
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-[10px]">
                <span className="px-3 bg-white dark:bg-slate-950 text-gray-400 dark:text-gray-500 font-bold uppercase tracking-widest text-[9px]">Or continue with</span>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full inline-flex justify-center items-center py-2.5 px-4 border-2 border-gray-100 dark:border-slate-800 rounded-xl shadow-sm bg-white dark:bg-slate-900 text-sm font-bold text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-slate-800 transition-all"
            >
          ...
          <p className="text-center mt-6 text-[12px] text-gray-500 dark:text-gray-400 font-medium tracking-tight">
            New here?{" "}
            <Link to="/signup" className="font-bold text-black dark:text-white hover:opacity-70 transition-opacity">
              Create Account
            </Link>
          </p>
        </div>
